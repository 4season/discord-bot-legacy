...
client.on('message', (msg) => {
    try {
        ...
        fs.readFile('/app/Data/switchTime.json', 'utf-8', function(err, data) {
            if (switching_time === " ") {
        ...
        if (msg.content === "/시간알림") {
            ...
            if (switching_time[0].switch === true) {
                ...
                fs.writeFileSync('/app/Data/switchTime.json','{ "switch": true }');
            ...
            if (switching_time[0].switch === false) {
                ...
                fs.writeFileSync('/app/Data/switchTime.json','{ "switch": false }');
